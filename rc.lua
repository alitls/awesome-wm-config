...
watch("pactl get-sink-volume @DEFAULT_SINK@", 2,
    function(widget, stdout)
        ...
        widget:get_children_by_id("text_role")[1]:set_text("Vol: " .. volume .. "%")
    end,
    volume_widget
)
...
awful.screen.connect_for_each_screen(function(s)
    ...
    awful.tag({"🧑‍💻 1.Code", "🌐 2.Web", "🖥️ 3.Term","🌅 4.Doc", "📦 5.Misc","🌌 6.Stuff",}, s, awful.layout.layouts[1])
    ...
    -- Create the wibox
    -- set size of top var or wibar
    s.mywibox = awful.wibar({ position = "top", screen = s,width=1700,height=24,
    shape=gears.shape.rounded_bar,})

    --cpu widget
    local cpu_widget = require("awesome-wm-widgets.cpu-widget.cpu-widget")
    -- volume widget
    local volume_widget_aw = require('awesome-wm-widgets.volume-widget.volume')
    --logout-popup-widget
...
globalkeys = gears.table.join(
    ...
    -- Fullscreen screenshot with Mod + ,
    awful.key({ modkey }, ",",
	    function () awful.spawn("xfce4-screenshooter -f") end,
	    {description = "Take fullscreen screenshot", group = "screenshot"}),

    -- Region screenshot with Mod + .
    awful.key({ modkey }, ".",
	    function () awful.spawn("xfce4-screenshooter -r") end,
	    {description = "Take region screenshot", group = "screenshot"})
)
...
awful.rules.rules = {
    ...
    { rule = { },
      properties = { border_width = beautiful.border_width,
		     ...
		     maximized    = false, -- open apps without maximizing
